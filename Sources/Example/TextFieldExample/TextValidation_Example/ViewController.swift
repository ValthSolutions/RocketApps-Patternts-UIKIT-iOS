...
final class RootView: NiblessView, IValidationForm {
    ...
    private(set) var newPasswordTextFieldView = TextFieldView(type: Skeleton.TextFieldConfigs.primary)
    private(set) var confirmPasswordTextFieldView = TextFieldView(type: Skeleton.TextFieldConfigs.secondary)
