...
public class Button: UIButton, Decoratable {
   ...
   private var pressedBorderColor: UIColor?
   ...
   private func setupPrimaryStyle(with style: Style) {
       guard case let .primary(defaultColor, pressedColor, disabledColor, iconTintColor) = style.type else { return }
   ...
   private func setupSecondaryStyle(with style: Style) {
       guard case let .secondary(borderWidth, defaultColor, pressedColor, disabledColor, iconTintColor) = style.type else { return }
   ...
   private func updateState() {
       if case .secondary = currentStyleType {
           let borderColor: UIColor? = !isEnabled ? disabledBorderColor : (isHighlighted ? pressedBorderColor : defaultBorderColor)
